...
<body class="bg-gray-100 min-h-screen pt-16 flex flex-col items-center justify-center">
    ...
    <div class="bg-white mt-4 shadow-lg rounded-lg p-8 max-w-4xl w-full flex flex-col md:flex-row">
        ...
        @foreach ($borrowings as $borrowing)
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                <div class="p-6">
                    ...
                    <div class="mt-4">
                        <form method="POST" action="{{ route('return', ['borrowing' => $borrowing->id]) }}">
                            @csrf
                            @method('PUT')
                            <button type="submit"
