...
<div class="max-w-4xl mx-auto mt-10">
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('books.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Ajouter un livre</a>
    </div>
                ...
                @foreach($books as $book)
                    <tr class="text-center">
                        ...
                        <td class="border p-3 space-x-2">
                            <a href="{{ route('books.edit', $book->id) }}" class="bg-yellow-500 text-white px-3 py-1 rounded-lg hover:bg-yellow-600">Modifier</a>
